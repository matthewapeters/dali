...
func TestButton(t *testing.T) {
	b := NewButton("This Is A Button", "MyTestButton", "MyTestButton", "do_MyTestButton")
...
func TestWindow(t *testing.T) {
	...
	p := NewDiv("TestDiv", "TestDiv")
	p.Elements.AddElement(NewButton("This is Button One", "buttonOne", "buttonOne", "do_buttonOne"))
	...
	p2 := NewDiv("TestDivTwo", "TestDivTwo")
